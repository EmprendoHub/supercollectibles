...
const AdminClientSearch = () => {
  ...
  return (
    ...
    >
      <input
        className="flex-grow appearance-none border border-gray-200 bg-background rounded-md mr-2 py-2 px-3 maxsm:px-0 hover:border-gray-400 focus:outline-none focus:border-gray-400 w-3/4"
        type="text"
