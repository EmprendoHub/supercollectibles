...
export const metadata = {
  title: "Términos de servicio de Super Collectibles MX",
  description: "Explora los Términos de servicio de Super Collectibles MX",
};
      ...
      <section className="hero mb-10 px-5 bg-slate-200 h-auto text-stone-700 text-center py-20 border border-slate-400 drop-shadow-md">
        <div className=" mx-auto">
          ...
          <p className="text-sm  mt-4 font-raleway text-sm ">
            ...
            incluida toda la información, herramientas y servicios disponibles
            en este sitio para usted, el usuario, condicionado a la aceptación
            de todos los términos, condiciones, políticas y avisos aquí
            establecidos.
          </p>
        </div>
      </section>
      <div className=" p-6 px-20 md:px-10 bg-slate-200 text-stone-700 py-20 border border-slate-400 drop-shadow-md">
        ...
        <section className="mb-4">
          ...
          <p className="mt-2 font-raleway text-sm">
            ...
            directo, indirecto, incidental, punitivo, especial, o daños
            emergentes de cualquier tipo, incluidos, entre otros, pérdida de
            beneficios, pérdida de ingresos, pérdida de ahorros, pérdida de
            datos, costos de reemplazo o cualquier daño similar, ya sea basado
            en contrato, agravio (incluida negligencia), responsabilidad
            estricta o de otro tipo, que surja de su uso de cualquiera de los
            servicios o cualquier producto adquirido utilizando el servicio, o
            por cualquier otro reclamo relacionado de alguna manera con su uso
            del servicio o cualquier producto, incluido, entre otros, cualquier
            error u omisión en cualquier contenido, o cualquier pérdida o daño
            de cualquier tipo incurrido como resultado del uso del servicio o
            cualquier contenido (o producto) publicado, transmitido o puesto a
            disposición a través del servicio, incluso si se le informa de su
        ...
        <section className="mb-4">
          ...
          <p className="mt-2 font-raleway text-sm">
            ...
            proveedores, pasantes y empleados, indemnes de cualquier reclamo o
            demanda, incluyendo Honorarios razonables de abogados, realizados
            por cualquier tercero debido a o que surjan de su incumplimiento de
            estos Términos de servicio o de los documentos que incorporan por
            referencia, o su violación de cualquier ley o los derechos de un
            tercero.
          </p>
        </section>
