  ...
  return (
    <div className="px-5">
      ...
      <Link href="/perfil/direcciones/nueva">
        <button className="px-4 py-2 inline-block text-gray-600 border border-gray-300 rounded-md hover:bg-background">
          ...
          <div>
            <Link href={`/perfil/direccion/${address._id}`}>
              <div className="mb-5 gap-4">
                <figure className="w-full flex align-center bg-background p-4 rounded-md cursor-pointer">
                  <div className="mr-3">
          ...
          <div className="flex flex-col justify-between items-center gap-1">
            <span>
              <Link
                ...
                className="px-2 py-2 inline-block text-white hover:text-blue-600 bg-black shadow-sm border border-gray-200 rounded-md hover:bg-background cursor-pointer"
              >
            ...
            <span>
              <button
                ...
                className="px-2 py-2 inline-block text-white hover:text-red-600 bg-red-600 shadow-sm border border-gray-200 rounded-md hover:bg-background cursor-pointer "
              >
                <FaTrash className="" />
              </button>
            </span>
