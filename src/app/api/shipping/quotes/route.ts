...
export async function POST(request: NextRequest) {
  try {
    ...
    // Función para normalizar códigos de país
    ...
    const quoteRequest = {
      ...
      destination: {
        ...
        country: normalizeCountryCode(destination.country || "MX"),
    ...
    console.log(
      "🚚 Solicitando cotizaciones de envío con Envía.com:",
      quoteRequest
    );
    ...
    console.error("❌ Error obteniendo cotizaciones de envío:", error);
